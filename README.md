...
#Is it Linux-Based
No this kernel does not use anything from linux or take anything this kernel stands on its own not FreeBSD-based or anything completly new
...
#Notes
This is still in development so do not expect it to be able to run desktops like XFCE 4 or Hyprland or Plasma you gotta wait for support and the files will ##ONLY BE RELEASED IN A .bin FORMAT
